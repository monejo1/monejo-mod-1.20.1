...
public class RainDropSlimeEntityModel<T extends Entity>
        extends SinglePartEntityModel<T> {
    private final ModelPart root;

    public RainDropSlimeEntityModel(ModelPart root) {
        this.root = root;
    }
    ...
    public static TexturedModelData getInnerTexturedModelData() {
        ...
        modelPartData.addChild(EntityModelPartNames.RIGHT_EYE, ModelPartBuilder.create().uv(32, 0).cuboid(-3.25f, 17.0f, -3.5f, 2.0f, 2.0f, 2.0f), ModelTransform.NONE);
        modelPartData.addChild(EntityModelPartNames.LEFT_EYE, ModelPartBuilder.create().uv(32, 4).cuboid(1.25f, 17.0f, -3.5f, 2.0f, 2.0f, 2.0f), ModelTransform.NONE);
