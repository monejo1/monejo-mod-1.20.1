package com.monejo.monejomod.particle.custom;
...
public class YellowBirchLeavesParticle
        extends SpriteBillboardParticle {
    private float field_43369;
    private final float field_43370;
    private final float field_43371;

    protected YellowBirchLeavesParticle(ClientWorld level, double xCoord, double yCoord, double zCoord,
                               SpriteProvider spriteSet) {
        super(level, xCoord, yCoord, zCoord);
        float f;
        this.setSprite(spriteSet.getSprite(this.random.nextInt(12), 12));
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType particleType, ClientWorld level, double x, double y, double z,
            ...
            return new YellowBirchLeavesParticle(level, x, y, z, this.sprites);
        }
    }
}
